...
<div class="header-wrapper">
    ...
    <div class="header-buttons">
        <a href="{{ route('laporan.surat-keluar.export-pdf', request()->query()) }}" 
...
<div class="card shadow-sm border-0 mb-3">
    ...
    <div class="card-body pb-2">
        <form method="GET" action="{{ route('laporan.surat-keluar') }}" class="filter-form row g-3">
            <div class="col-md-3">
            ...
            <div class="col-md-12">
                <div class="filter-buttons">
                    ...
                    <a href="{{ route('laporan.surat-keluar') }}" class="btn btn-secondary btn-sm">
...
<div class="card shadow-sm border-0">
    <div class="card-header bg-light border-bottom d-flex justify-content-between align-items-center">
        <h6 class="mb-0"><i class="bi bi-list"></i> Data Surat Keluar</h6>
